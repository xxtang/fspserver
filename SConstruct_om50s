...
#om50s
env = Environment(ENV=os.environ,CPPPATH=['#/include','#/p2pnat/include'],LIBPATH=['/usr/lib','/usr/local/lib','/var/lib','#/p2pnat/lib/om50s'],LIBS=['p2pnat','pthread'],CC='mipsel-buildroot-linux-uclibc-gcc');
# Import GZip builder
import gzipBuilder
